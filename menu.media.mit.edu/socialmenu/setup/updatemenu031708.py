...
##########################################
# For updating to latest menu on 3/17/10
##########################################
...
# 3/17/10 crispy fried description added
m.description="also available crispy fried; choice of two sides"
m.category=c
m.price=22.95
m.save()
...
# added 3/17/10
try:
    MenuItem.objects.get(name="Lemon Caper Grey Sole")
except MenuItem.DoesNotExist:
    m = MenuItem(name="Lemon Caper Grey Sole", description="lemon beurre blanc, jasmine rice, sauteed spinach", price=19.95, category=c)
    m.save()
