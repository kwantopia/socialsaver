...
if ($production) {
    // Production
    stream_context_set_option($ctx, 'ssl', 'local_cert', '../keys/otn_prodcert.pem');
    ...
    // Sandbox
    stream_context_set_option($ctx, 'ssl', 'local_cert', '../keys/otn_devcert.pem');
    //stream_context_set_option($ctx, 'ssl', 'passphrase', $pass);
    // Sandbox
